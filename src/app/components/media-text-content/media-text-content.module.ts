...
import { MediaTextContentRoutingModule } from './media-text-content-routing.module';
...
@NgModule({
  declarations: [AddMediaTextContentComponent,ListMediaTextContentComponent,EditMediaTextContentComponent],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    MediaTextContentRoutingModule,
    NgbModule,
    AgGridAngular,
    GalleryModule,
    DropzoneModule,
  ...
  providers: [
    ...
    NgbActiveModal,
    MediaTextContentService
  ]
})
export class MediaTextContentModule { }
