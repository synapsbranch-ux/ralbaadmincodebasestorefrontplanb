...
@Component({
  selector: 'vendor-approved-products-list',
  templateUrl: './vendor-approved-products-list.component.html',
  styleUrls: ['./vendor-approved-products-list.component.scss']
})
export class VendorApprovedProductListComponent implements OnInit {
  ...
  productlist(page: number, pageSize: number, vendor_id) {
    this.vendorService.allAdminApprovedProductlist(page + 1, pageSize, this.route.snapshot.paramMap.get('id')).subscribe(
      res => {
