...
@Component({
selector: 'list-addons-verient',
templateUrl: './list-addons-verient.component.html',
styleUrls: ['./list-addons-verient.component.scss']
})
export class ListAddonsVerientComponent implements OnInit {
  userrole:any;
